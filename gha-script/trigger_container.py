...
def trigger_script_validation_checks(image_name = "registry.access.redhat.com/ubi9/ubi:9.6"):
...
container_result=trigger_script_validation_checks(image_name = "registry.access.redhat.com/ubi9/ubi:9.6")
if container_result:
