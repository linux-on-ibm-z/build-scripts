    ...
    try:
        ...
        while True:
            ...
            if remote_sha is None:
                logger.info("COS SHA metadata missing → using suffix s390x1")
                return suffix
            # CASE 2 - SHA matches
